      ...
      >
        <div className="detail px-4 mb-10 flex flex-col items-center text-center lg:text-left lg:items-start">
          ...
          <p className="text-grayish-blue text-base">
            Get your Phone as quickly as possible. Keep track to your deliveries
        ...
        <div className="detail px-4 mb-10 flex flex-col items-center text-center lg:text-left lg:items-start">
          ...
          <p className="text-grayish-blue text-base">
            The iphones and ear pods available are just within the reach of your
            pocket. No hidden cost. No addtional fee required other than what’s
            stated.
          </p>
        </div>
        <div className="detail px-4 mb-10 flex flex-col items-center text-center lg:text-left lg:items-start">
          ...
          <p className="text-grayish-blue text-base">
            From your favorite brand to the latest trends.
          </p>
        </div>
      </div>
    </section>
